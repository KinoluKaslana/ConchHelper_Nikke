...
class award extends baseFunc{
    ...
    static AwardFriendPoint() {
        ...
        while (true) {
            if((!nikkeServer && ok := selfFindText(&X, &Y, nikkePosX + 0.628 * nikkePosW . " ", nikkePosY + 0.822 * nikkePosH . " ", nikkePosX + 0.628 * nikkePosW + 0.010 * nikkePosW . " ", nikkePosY + 0.822 * nikkePosH + 0.017 * nikkePosH . " ", 0.4 * PicTolerance, 0.4 * PicTolerance, selfFindText().PicLib("红点"), , , , , , , zoomW, zoomH)) || 
